// Package mssql is the placeholder Go side of
// `services/connector-management-service/src/connectors/mssql.rs`.
//
...
//
// When Rust grows a real MSSQL connector, the file-by-file port lands
...
const ConnectorType = "mssql"

// Adapter is the skeleton [adapters.ConnectorAdapter] for MSSQL. It holds
...
// `connectors::mssql` module is an empty placeholder.
