// Package oracle is the placeholder Go side of
// `services/connector-management-service/src/connectors/oracle.rs`.
//
...
//
// When Rust grows a real Oracle connector, the file-by-file port lands
...
const ConnectorType = "oracle"

// Adapter is the skeleton [adapters.ConnectorAdapter] for Oracle. It
...
// `connectors::oracle` module is an empty placeholder.
